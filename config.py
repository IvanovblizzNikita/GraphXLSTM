...
class MoleculeConfig:
    def __init__(self):
        ...
        self.use_jumping_knowledge = True

        # Sequence model (mLSTM)
        self.num_mlstm_layers = 10
        self.mlstm_num_heads = 16

        # IMPORTANT
        self.context_length = 512  # must >= max molecule length

        # Compatibility
        # keep this for logging / scripts that expect it
        self.latent_dimension = self.gnn_d_model

        # Environment options
        self.wall_clock_limit = 3600 * 8  # in seconds. If no limit, set to None
        ...
        # ranolazine_mpo osimertinib_mpo fexofenadine_mpo perindopril_rings amlodipine_rings sitagliptin_replacement zaleplon_mpo
        # valsartan_smarts deco_hop scaffold_hop isomers_c11h24 isomers_c9h10n2o2pf2cl median_camphor_menthol median_tadalafil_sildenafil
        # celecoxib_rediscovery troglitazone_rediscovery thiothixene_rediscovery aripiprazole_similarity albuterol_similarity mestranol_similarity
        ...
        self.objective_type = "median_camphor_menthol"  # either "IBA" or "DMBA_TMB" for solvent design, or goal-directed task from GuacaMol (see README)
        ...
        self.load_checkpoint_from_path = "xLSTM_512.pt"  # If given, model checkpoint is loaded from this path.
