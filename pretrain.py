...
def train_for_one_epoch(epoch: int, config: MoleculeConfig, network: SparseGraphGNN_mLSTM,
...
if __name__ == '__main__':
    ...
    training_device = "cuda:3"  # Device on which to train.
    ...
    if pretrain_num_epochs > 0:
        ...
        for epoch in range(pretrain_num_epochs):
            ...
            if validation_metrics["val_full_loss"] < checkpoint["pretrain_best_validation_loss"]:
                ...
                checkpoint["pretrain_best_validation_loss"] = validation_metrics["val_full_loss"]
